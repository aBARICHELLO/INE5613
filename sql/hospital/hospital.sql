...
CREATE TABLE ambulatorios (
    ...
    andar           NUMERIC(3)          NOT NULL UNIQUE CONSTRAINT andar_positivo CHECK (andar > 0),
    capacidade      SMALLINT            NOT NULL UNIQUE CONSTRAINT idade_positiva CHECK (capacidade > 0)
);
